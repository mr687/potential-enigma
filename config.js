...
let selectedChain = process.env.CHAIN || "local"

const settings = {
  local: {
    phrase:
      "coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin coin",
    packageId: "",
    firstVPackageId: "",
    packagePath: "./move",
  },
...
const phrase = process.env.PASSPHRASE
const fomo = process.env.ENABLE_FOMO === "true"
const meta = process.env.ENABLE_META === "true"
settings[selectedChain].chain = selectedChain
if (phrase) {
  settings[selectedChain].phrase = phrase
}
